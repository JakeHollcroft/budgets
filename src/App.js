...
function App() {
  ...
  return (
    <>
      ...
      <EditBudgetModal show={editBudgetId != null} handleClose={() => setEditBudgetId(null)} budgetId={editBudgetId} />
      <AddCheckModal show={showAddCheckModal} handleClose={() => setShowAddCheckModal(false)} />
    </>
  );
}
